...
def parse_args():
    ...
    parser.add_argument(
        "--MOBILE_SAM_CHECKPOINT_PATH", type=str, default="/home/zongxin/works/icml/rvos/Grounded-Segment-Anything/ckpt/mobile_sam.pt", help="model"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--OUT_FILE_BOX", type=str, default="/home/zongxin/works/icml/rvos/Grounded-Segment-Anything/out/groundingdino_annotated_image.jpg", help="the output filename"
    )
    parser.add_argument(
        "--OUT_FILE_SEG", type=str, default="/home/zongxin/works/icml/rvos/Grounded-Segment-Anything/out/grounded_mobile_sam_annotated_image.jpg", help="the output filename"
    )
    parser.add_argument(
        "--OUT_FILE_BIN_MASK", type=str, default="/home/zongxin/works/icml/rvos/Grounded-Segment-Anything/out/grounded_mobile_sam_bin_mask.jpg", help="the output filename"
    )
